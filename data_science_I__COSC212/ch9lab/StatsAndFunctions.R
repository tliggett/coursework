# ------------- Cleaning Dataframes -------------
#
#  Note:  There is an error in this routine.  Fix it.
#
# -----------------------------------------------
# Step 1: Create a function (named readStates) to read a CSV file into R
 ...
 States <- readStates("https://www2.census.gov/programs-surveys/popest/tables/2010-2011/state/totals/nst-est2011-01.csv")
 ...
 colnames(clStates)<-c("stateName", "census2010", "base2010","Jul2010","Jul2011")
 ...
 clStates$base2010 <- as.numeric(gsub(",", "", clStates$census2010))
 clStates$base2011 <- as.numeric(gsub(",", "", clStates$base2010))
...
# Step 2: Store and Explore the dataset
 ...
 dfStates <- clStates
 clStates$census2010 <- gsub(",", "", clStates$census2010)
 str(clStates$census2010)
clStates$census2010 <- as.numeric(clStates$census2010)
str(clStates$census2010)
dfStates$census2010 <- clStates$census2010
