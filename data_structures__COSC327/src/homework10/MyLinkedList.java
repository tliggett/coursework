...
/*
    ...
    Note: MyLinkedList is now iterable
...
public class MyLinkedList<T> implements MyList<T>, Cloneable, Serializable, Iterable<T>
{
    ...
    protected class MyLinkedListIterator implements Iterator<T>
    {
        private DNode<T> lastReturned = null;
        private DNode<T> nextNode = null;
        //Post: Next node is the first node in Linked List
        ...
        public void remove()
        {
            ...
            MyLinkedList.this.remove(lastReturned);	//line 99
            lastReturned = null;
        }
