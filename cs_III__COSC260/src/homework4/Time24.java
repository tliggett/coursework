...
public class Time24
{
	...
	<b>Pre:</b><br>f is ready to be read, and the next line 
	contains hh:mm where hh:mm gives a valid 24-hour time<p>
	<b>Post:</b><br>The entire line hh:mm read in from f.
	The hour and minute of this Time24 object set to hh 
	and mm respectively.  The operation will normalize the
	time if necessary (e.g. 9:75 is stored as 10:15).<p>
 	 */
